...
_comparison_eda.R_ : Exploratory analysis contains comparison of first moments, extreme values (gumbel probability), wet days (intersection plots). These results are also presented below.
